-- ユーザー権限管理とIntroducers機能の追加
-- 作成日: 2025-01-30
-- 説明: user_rolesテーブルとintroducersテーブルを作成
...
-- コメント追加
COMMENT ON TABLE public.user_roles IS 'ユーザーの権限管理テーブル';
COMMENT ON COLUMN public.user_roles.user_id IS 'ユーザーID（auth.usersテーブルの参照）';
COMMENT ON COLUMN public.user_roles.role IS 'ユーザーの権限（admin/editor/viewer）';
