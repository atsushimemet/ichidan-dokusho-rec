-- 紹介者機能の追加（既存認証システム準拠版）
-- 作成日: 2025-01-30
-- 説明: 既存のauth.role()パターンに合わせたintroducersテーブル作成
...
-- 書き込み権限（認証済みユーザーのみ）- 既存パターンに合わせる
CREATE POLICY "introducers_write_authenticated" ON public.introducers
  FOR ALL
